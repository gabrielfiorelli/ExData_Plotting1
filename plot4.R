...
electricData <- mutate(electricData, Voltage = as.numeric(Voltage))
electricData <- mutate(electricData, Global_reactive_power = as.numeric(Global_reactive_power))
...
#PLOT_1
with(electricData,
     plot(DateTime, Global_active_power_numeric,
          type = "l",
